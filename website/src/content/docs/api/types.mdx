...
This reference documents all the types, classes, and interfaces used in Flutter InstantDB, providing complete type information for building type-safe applications.
...
Flutter InstantDB uses the `signals_flutter` package for reactivity:
