...
Beyond `limit` / `offset` (covered in [Basics](../basics/)), InstantDB supports cursor
...
composite key. See [Typed Relations](../../typed/relations/#per-relation-pageinfo) for
details — the key looks like `result.pageInfo?['goals.todos']`.

## Typed equivalent

The [typed query DSL](../../typed/query-dsl/#pagination-and-limits) exposes
