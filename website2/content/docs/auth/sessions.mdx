...
description: Managing user sessions, tokens, and authentication persistence in Flutter InstantDB
---

Flutter InstantDB provides robust session management with automatic token handling, refresh mechanisms, and secure storage. Sessions persist across app restarts and handle token expiration gracefully.
...
- [User Management](/docs/auth/users) - User authentication methods
- [Permissions](/docs/auth/permissions) - Role-based access control
- [Offline Authentication](/docs/advanced/offline) - Handling auth when offline
- [Security Best Practices](/docs/advanced/troubleshooting) - Advanced security considerations
