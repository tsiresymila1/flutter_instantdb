...
| `baseUrl` | `String` | `'https://api.instantdb.com'` | InstantDB API endpoint |
...
- [Schema Definition](/docs/concepts/schema) - Structure your data
- [Queries](/docs/queries/basics) - Fetch data reactively
- [Mutations](/docs/concepts/transactions) - Create, update, and delete data
- [Real-time Sync](/docs/realtime/sync) - Handle live updates
