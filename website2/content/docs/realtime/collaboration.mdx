...
description: Build multi-user collaborative experiences with Flutter InstantDB
---
...
- [Presence System](/docs/realtime/presence) - Detailed presence API reference
- [WebSocket Sync](/docs/realtime/sync) - Understanding real-time synchronization
- [Authentication](/docs/auth/users) - User management for collaboration
- [Performance Tips](/docs/advanced/performance) - Optimizing collaborative features
